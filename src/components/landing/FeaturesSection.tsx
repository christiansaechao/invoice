      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="text-center flex flex-col items-center gap-4">
            ...
            <h2 className="text-4xl md:text-5xl font-serif font-extrabold leading-tight text-slate-900">
              Master Your Creative
              <br />
              <span className="text-[#6200EE]">Revenue Streams</span>
            </h2>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center pt-8">
          ...
          <div className="flex flex-col gap-8">
            <h2 className="text-4xl md:text-5xl font-serif font-extrabold leading-[1.1] text-slate-900">
            ...
            <ul className="flex flex-col gap-6">
              {BULLETS.map((b) => (
                <li key={b.title} className="flex items-start gap-4">
                  <span className="mt-1.5 w-2 h-2 rounded-full bg-[#6200EE] flex-shrink-0" />
                  <div className="flex flex-col gap-1">
                    <span className="font-bold text-slate-900 text-sm">{b.title}</span>
                    <span className="text-sm text-slate-500 leading-relaxed">{b.desc}</span>
                  </div>
                </li>
              ))}
            </ul>
